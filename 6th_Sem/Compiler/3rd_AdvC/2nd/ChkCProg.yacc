...
%type<string> primary_expression postfix_expression argument_expression_list unary_expression unary_operator cast_expression

%type<string> multiplicative_expression additive_expression shift_expression relational_expression equality_expression and_expression exclusive_or_expression inclusive_or_expression logical_and_expression logical_or_expression conditional_expression assignment_expression assignment_operator
...
multiplicative_expression
	: cast_expression				       { $$ = $1; }
	| multiplicative_expression '*' cast_expression        { $$ = InterCode((char *)$1, (char *)$3, '*'); 
...
additive_expression	
	...
	| additive_expression '+' multiplicative_expression    { $$ = InterCode((char *)$1, (char *)$3, '+'); 
	                                                         fprintf(fout,"MOV %s,%s \nADD %s,%s\n", $$,$1,$$,$3); }
	| additive_expression '-' multiplicative_expression    { $$ = InterCode((char *)$1, (char *)$3, '-'); 
								 fprintf(fout,"MOV %s,%s \nSUB %s,%s\n", $$,$1,$$,$3); }
	;
...
assignment_expression
	: conditional_expression					{ printf("Ass_exp1\n"); $$ = $1; }
	| unary_expression assignment_operator assignment_expression    { printf("Ass_exp2\n");  InterCode((char *)$1, (char *)$3, '=');
								          fprintf(fout,"MOV %s, %s\n",$1, $3); }
	;
