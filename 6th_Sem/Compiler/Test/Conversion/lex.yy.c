...
static yyconst flex_int16_t yy_nxt[20] =
    {   0,
        4,    7,   11,    6,    4,   10,    9,    6,    5,    5,
        8,   11,    3,   11,   11,   11,   11,   11,   11
    } ;

static yyconst flex_int16_t yy_chk[20] =
    {   0,
        1,   13,    0,    1,    2,    9,    8,    2,   12,   12,
        6,    3,   11,   11,   11,   11,   11,   11,   11
    } ;
...
char *yytext;
#line 1 "Conversion.lex"
#line 2 "Conversion.lex"
   #include <stdio.h>
   #include <string.h>
   #include <stdlib.h>
...
case 1:
YY_RULE_SETUP
#line 12 "Conversion.lex"
{ return 0; }
	YY_BREAK
case 2:
YY_RULE_SETUP
#line 14 "Conversion.lex"
{ strcpy(oldText, yytext); lowToUp(oldText); }
	YY_BREAK
case 3:
YY_RULE_SETUP
#line 15 "Conversion.lex"
ECHO;
	YY_BREAK
#line 758 "lex.yy.c"
