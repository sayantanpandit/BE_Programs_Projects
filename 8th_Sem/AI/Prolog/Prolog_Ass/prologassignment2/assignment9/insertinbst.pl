...
insert_in_bst(X,t(Left,Root,Right),t(Left1,Root,Right)):-X<Root,!,insert_in_bst(X,Left,Left1).
insert_in_bst(X,t(Left,Root,Right),t(Left,Root,Right1)):-X>Root,!,insert_in_bst(X,Right,Right1).
/*Checking:
